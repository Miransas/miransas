...
export function Navbar() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex w-full items-center justify-between mx-auto mt-0 max-w-[90rem] px-6 py-4 md:px-10 lg:px-12',
          'border-x-0 border-t-0 transition-colors duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]',
          scrolled
